# Inspiration Cloud V2 — mockup

Interactive high-fidelity mockup for phase 1 of Inspiration Cloud V2.
Single self-contained `index.html`; only webfonts are loaded externally.
...
3. Idee → materiaal — channel tabs; the action bar shows who delivers per channel
...
The site is marked `noindex` and served from a private repo. The URL itself is
publicly reachable — GitHub only offers access-controlled Pages on Enterprise
Cloud — so treat the link as the only barrier.
